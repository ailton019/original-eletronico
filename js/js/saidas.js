...
// CORRIGIDO: Função declarada com function (hoisted)
...
// CORRIGIDO: Verificar permissão
function temPermissaoSaidas(modulo, acao = 'ver') {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!temPermissaoSaidas('saidas', 'ver')) {
    ...
    window.cancelarVenda = async (vendaId) => {
        if (!temPermissaoSaidas('saidas', 'cancelar')) {
    ...
    function renderizarVendas(vendas) {
        ...
        const podeCancelar = temPermissaoSaidas('saidas', 'cancelar');
        
        tbody.innerHTML = vendas.map(v => {
            const cancelado = v.cancelado || false;
            // CORRIGIDO: Chamar a função corretamente
            const podeCancelarVenda = !cancelado && podeCancelarVenda(v.data_finalizacao);
    ...
    async function finalizarVenda() {
        if (!temPermissaoSaidas('saidas', 'criar')) {
